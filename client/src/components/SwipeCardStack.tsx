...
const SwipeCardStack = ({
  ...
  return (
    <div className="relative h-[600px] w-full max-w-md mx-auto">
      ...
      {!isLoading && !hasMovies && (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 bg-[#1E293B] rounded-xl">
          <svg
            ...
            className="h-12 w-12 text-[#675AFE] mb-4"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
          ...
          <p className="text-sm text-[#EAEAEA]/70 mb-6">
            Adjust your filters or check out your favorites!
          </p>
          <button
      ...
      {/* Movie Detail Modal */}
      {selectedMovie && (
        <MovieDetailModal movie={selectedMovie} onClose={handleCloseDetails} />
      )}
    </div>
  );
};
